...
const Auth = () => {
  ...
  const { login, signup, signInWithGoogleIdToken, resetPassword, updatePassword, session } = useAuth();
  ...
  // Initialize Google Identity Services for ID Token Sign-in
  useEffect(() => {
    let intervalId;
    const initGoogle = () => {
  ...
  }, [mode, signInWithGoogleIdToken, navigate]);
